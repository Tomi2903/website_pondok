<nav class="w-1/4 bg-green-700 text-white min-h-screen p-4">
    ...
    <ul class="space-y-4">
        ...
        <li><a href="{{ route("admin.data_santri") }}" class="block hover:bg-green-600 rounded-lg px-4 py-2">Data Santri</a></li>
        <li><a href="{{ route('admin_register') }}" class="block hover:bg-green-600 rounded-lg px-4 py-2">Tambahkan admin</a></li>
        <li><a href="{{ route('penerimaan.index') }}" class="block hover:bg-green-600 rounded-lg px-4 py-2">Penerimaan</a></li>
